...
public class GunController : MonoBehaviour
{
    ...
    private void ThrowBomb(Vector3 mousePosition)
    {
        ...
        SoundManagerSO.PlaySoundFXClip(GameController.Instance.sound_Bomb, direction, 0.4f);
    }
    ...
    private void FireBullet(Vector2 direction)
    {
        ...
        SoundManagerSO.PlaySoundFXClip(GameController.Instance.sound_Shotgun, transform.position, 0.6f);
        StartCoroutine("ResetForceFeedback");
